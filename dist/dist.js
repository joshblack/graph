...
},{}],"/Users/joshblack/Desktop/graph/lib/AdjacencyMatrix.js":[function(require,module,exports){
"use strict";
...
AdjacencyMatrix.prototype.initialize = function initialize(nodes, isEdge) {
  ...
  for (i = 0; i < length; i++) {
    matrix[i] = [];
    for (j = 0; j < length; j++) {
      isEdge(nodes[i], nodes[j]) ? matrix[i].push(1) : matrix[i].push(0);
    }
  }
  return matrix;
};
...
AdjacencyMatrix.prototype.findEdge = function findEdge(n1, n2) {
  var first = this._nodes.indexOf(n1),
