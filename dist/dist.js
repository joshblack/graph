...
},{"./util":3,"es6-shim":5}],2:[function(require,module,exports){
"use strict";
...
function neighbors(V, M) {
  return function (v) {
    var row = M[V.indexOf(v)], _neighbors = [];

    row.forEach(function (e, i) {
      if (e === 1) _neighbors.push(i);
    });

    return _neighbors.map(function (e) {
      return V[e];
    });
  };
}
...
},{"es6-shim":5}],4:[function(require,module,exports){
